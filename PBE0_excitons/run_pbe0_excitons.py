...
if __name__ == '__main__':
    ...
    for frame in frame_range:
        ...
        for i in range(27):
            positions1, partial_charges = read_gaussian.read_positions_and_charges(f"../PBE0/PBE0_ground_trunc_bchla_{i+1}_frame_{frame}.log", 79, False)
            positions2, transition_charges = read_gaussian.read_positions_and_charges(f"../PBE0/PBE0_transition_trunc_bchla_{i+1}_frame_{frame}.log", 79, True)
            positions3, excited_partial_charges = read_gaussian.read_positions_and_charges(f"../PBE0/PBE0_excited_trunc_bchla_{i+1}_frame_{frame}.log", 79, False)
            
            tddft_result = read_gaussian.read_gaussian(f"../PBE0/PBE0_ground_trunc_bchla_{i+1}_frame_{frame}.log")
